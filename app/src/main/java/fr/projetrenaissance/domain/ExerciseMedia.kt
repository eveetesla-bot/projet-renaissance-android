...
enum class ExerciseMediaType { GUIDED_ILLUSTRATION, MACHINE_PHOTO, VERIFIED_EXTERNAL_VIDEO, BOOK_SHEET }
...
object ExerciseMediaCatalog {
    ...
    private fun machine(
        ...
        localResource = null,
        source = null,
        verificationStatus = MediaVerificationStatus.TO_VALIDATE,
    ...
    val all = listOf(
        ExerciseMedia(
            ...
            machine("Vélo cardio assis", "Vélo ergométrique", "Droit, semi-allongé", "Hauteur et recul de selle, sangles de pédales, niveau de résistance."),
        ...
        ExerciseMedia(
            ...
            machine("Presse inclinée ou horizontale", "Presse à cuisses", "À charge guidée, à disques, horizontale", "Inclinaison du dossier, butée de départ, placement des pieds, poignées latérales."),
        ...
        ExerciseMedia(
            ...
            machine("Presse poitrine assise", "Chest press", "Convergente, horizontale, prise neutre", "Hauteur du siège, dossier, position de départ, poignées."),
        ...
        ExerciseMedia(
            ...
            machine("Rowing à poulie basse", "Rowing assis", "Poulie, convergent, poitrine appuyée", "Repose-pieds, siège, appui poitrine, poignée neutre."),
        ...
        ExerciseMedia(
            ...
            machine("Leg curl assis", "Leg curl", "Assis, couché, debout unilatéral", "Axe du genou, dossier, maintien des cuisses, rouleau des chevilles."),
        ...
        ExerciseMedia(
            ...
            machine("Haltères légers ou machine", "Élévation latérale", "Haltères, poulie basse, machine à coussins", "Charge, hauteur de siège et position des coussins selon la variante."),
        ...
        ExerciseMedia(
            ...
            machine("Presse à cuisses", "Mollets à la presse", "Presse inclinée, horizontale, machine mollets", "Dossier, butée, placement sécurisé de l’avant-pied."),
        ...
        ExerciseMedia(
            ...
            machine("Hip thrust guidé", "Machine hip thrust", "Machine à ceinture, Smith machine, banc", "Appui dorsal, coussin ou ceinture pelvienne, position des pieds."),
        ...
        ExerciseMedia(
            ...
            machine("Leg extension assis", "Leg extension", "Bilatéral, unilatéral", "Axe du genou, dossier, rouleau des tibias, amplitude de départ."),
        ...
        ExerciseMedia(
            ...
            machine("Abducteurs assis", "Machine abducteurs", "Dossier droit ou incliné", "Dossier, angle de départ, coussins latéraux, repose-pieds."),
        ...
        ExerciseMedia(
            ...
            machine("Aucune machine", "Tapis de sol", "Tapis épais, banc plat si validé", "Surface stable, espace libre, tête soutenue si nécessaire."),
        ...
        ExerciseMedia(
            ...
            machine("Aucune machine", "Tapis de sol", "Tapis, banc plat avec appui stable", "Surface antidérapante et espace libre."),
